...
function ProjectCard({ title, imgSrc, link }) {
  return (
    ...
    <Image src={imgSrc} alt={title} width="1000" height="1000" className="object-cover " />
...
export default function Home() {
  const projects = [
    ...
    { title: "School-Design", imgSrc: "/school/ME371/transmission1.JPG", link: "/product-design/school" },
    {
      title: "Research-Design",
      imgSrc: "/research/research2.JPG",
      link: "/product-design/research",
    },
    {
      title: "Personal-Design",
      imgSrc: "/personal/bikeStem/bike1.PNG",
      link: "/product-design/personal",
    },
...
<div className="max-w-7xl mx-auto bg-gradient-to-b from-white  to-blue-50 rounded-xl p-10 mb-10 shadow-lg border border-gray-200">
  <h1 className="text-4xl font-extrabold text-center text-gray-900">Welcome!</h1>
  <p className="text-center text-xl mt-4 font-light text-gray-700">Please explore my website!</p>
</div>
    ...
    <div className="max-w-7xl mx-auto bg-white rounded-xl p-8 shadow-md mb-10">
      ...
      <div className="max-w-7xl mx-auto bg-white rounded-xl p-8 shadow-md">
        ...
        <p className="text-lg text-gray-700 mb-8">A selection of projects I've worked on:</p>
