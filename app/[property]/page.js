...
const projectOptions = {
  ...
  "design-school": [
...

    {
      ...
      summary: `In my junior level design class, our challenge was to create a 4-legged walking robot. The project required that the two front legs be 4 bar linkages, and the two hind legs use a cam-mechanism. It also required a simulated path trace and CAD animation of the 4 bar linkages as well as the cam-mechanism. The walk path was optimized to have a long stride and fast return. The cam mechanism was optimized to minimize the jolts and acceleration in the x and y direction of the follower. The walker robot was able to walk 8 meters in a straight path in under 45 seconds.`,
      images: [
